...
| `lib/supabase/client.ts` | Returns a browser‑side Supabase client for use in client components. |
| `lib/supabase/server.ts` | Returns a server‑side Supabase client bound to the current request’s cookies. |
